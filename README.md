...
- Manage appointments (accept, reject, or mark completed)
- Manage and assign stylists to services and appointments
- View detailed sales and booking reports
- Manage website content (About Us, Contact)
...
- Contact salon through contact form
...
- When selecting a stylist, unavailable time slots are marked as **red** or shown as **“Time slot unavailable”**
- Prevents double-booking of the same stylist at the same time
- Automatic random assignment of stylist if customer doesn’t choose one
...
| **Backend** | PHP (Core PHP with procedural logic) |
| **Database** | MySQL |
| **Server** | XAMPP / WAMP / LAMP |
| **Payment Integration** | Stripe API |
| **Other Tools** | AJAX, PHPMailer (optional), Chart.js (for reports) |
